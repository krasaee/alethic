...
## Introduction
Welcome to the Alethic ISM project group! Born from the study 
![The Case for Animal-Friendly LLMs](docs/Ghose, Tse, Rasaee, Sebo, Singer.pdf)
this project is a journey into experimental language instruction processing, exploring how language models respond to animal-related queries, of course not limited to this only.
